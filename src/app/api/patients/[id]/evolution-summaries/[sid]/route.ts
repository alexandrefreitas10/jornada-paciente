...
export async function DELETE(
  ...
  await logAudit({ userName, action: 'DELETE', entityType: 'evolution_summary', entityId: sid, patientId: Number(id), details: date, deletedData: summary as Record<string, unknown> ?? undefined })
